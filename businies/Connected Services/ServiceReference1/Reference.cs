...
namespace businies.ServiceReference1 {
    ...
    public interface KPSPublicSoap {
        ...
        businies.ServiceReference1.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(businies.ServiceReference1.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<businies.ServiceReference1.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(businies.ServiceReference1.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public businies.ServiceReference1.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(businies.ServiceReference1.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public businies.ServiceReference1.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(businies.ServiceReference1.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : businies.ServiceReference1.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<businies.ServiceReference1.KPSPublicSoap>, businies.ServiceReference1.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        businies.ServiceReference1.TCKimlikNoDogrulaResponse businies.ServiceReference1.KPSPublicSoap.TCKimlikNoDogrula(businies.ServiceReference1.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            businies.ServiceReference1.TCKimlikNoDogrulaRequest inValue = new businies.ServiceReference1.TCKimlikNoDogrulaRequest();
            inValue.Body = new businies.ServiceReference1.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            businies.ServiceReference1.TCKimlikNoDogrulaResponse retVal = ((businies.ServiceReference1.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<businies.ServiceReference1.TCKimlikNoDogrulaResponse> businies.ServiceReference1.KPSPublicSoap.TCKimlikNoDogrulaAsync(businies.ServiceReference1.TCKimlikNoDogrulaRequest request) {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<businies.ServiceReference1.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            businies.ServiceReference1.TCKimlikNoDogrulaRequest inValue = new businies.ServiceReference1.TCKimlikNoDogrulaRequest();
            inValue.Body = new businies.ServiceReference1.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((businies.ServiceReference1.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
